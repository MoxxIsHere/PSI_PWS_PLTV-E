...
CREATE TABLE `fatura` (
  ...
  CONSTRAINT `fk_cliente` FOREIGN KEY (`cliente`) REFERENCES `user` (`idUser`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_funcionario` FOREIGN KEY (`funcionario`) REFERENCES `user` (`idUser`) ON DELETE NO ACTION ON UPDATE NO ACTION
